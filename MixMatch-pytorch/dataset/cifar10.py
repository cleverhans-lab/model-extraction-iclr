...
def get_cifar10(root, n_labeled,
    ...
    train_labeled_idxs, train_unlabeled_idxs, val_idxs = train_val_split(test_dataset.targets, int(n_labeled/10))

    train_labeled_dataset = CIFAR10_labeledmod(root, train_labeled_idxs, train=False, transform=transform_train)
    train_unlabeled_dataset = CIFAR10_unlabeled(root, train_unlabeled_idxs, train=False, transform=TransformTwice(transform_train))
    val_dataset = CIFAR10_labeled(root, val_idxs, train=True, transform=transform_val, download=True)
    test_dataset = CIFAR10_labeled(root, val_idxs, train=False, transform=transform_val, download=True)
