...
def main():
    ...
    if args.dataset == 'cifar10':
        ...
        train_labeled_set, train_unlabeled_set, val_set, test_set, val_idxs = cifar10.get_cifar10(
        ...
        test_loader = data.DataLoader(test_set, batch_size=args.batch_size,
                                      shuffle=False, num_workers=0)
        test_loader2 = data.DataLoader(test_set, batch_size=1,
                                       # for fidelity accuracy
                                       shuffle=False, num_workers=0)
        ...
        train_labeled_set, train_unlabeled_set, val_set, test_set, val_idxs = mnist.get_mnist(
            './data', args.n_labeled,
        ...
        train_labeled_set, train_unlabeled_set, val_set, test_set, val_idxs = svhn.get_svhn(
            './data', args.n_labeled, transform_train=transform_train,
            transform_val=transform_val)
        labeled_trainloader = data.DataLoader(train_labeled_set,
                                              batch_size=args.batch_size,
        ...
        test_loader = data.DataLoader(test_set, batch_size=args.batch_size,
                                      shuffle=False, num_workers=0)
        test_loader2 = data.DataLoader(test_set, batch_size=1, # for fidelity accuracy
                                      shuffle=False, num_workers=0)
    # Model
    ...
    if args.resume:
        ...
        logger.set_names(
            ['Train Loss', 'Train Loss X', 'Train Loss U', 'Valid Loss',
             'Valid Acc.', 'Test Loss', 'Test Acc.', 'Fidelity Acc.'])
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        test_acc2 = fidelity(test_loader2, ema_model, args.dataset, use_cuda, val_idxs)
